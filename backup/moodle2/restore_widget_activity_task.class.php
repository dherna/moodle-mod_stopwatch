...
require_once($CFG->dirroot . '/mod/stopwatch/backup/moodle2/restore_stopwatch_stepslib.php');

/**
 * Restore task for the stopwatch activity module
 *
...
class restore_stopwatch_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('NEWMODULEVIEWBYID', '/mod/stopwatch/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('NEWMODULEINDEX', '/mod/stopwatch/index.php?id=$1', 'course');
