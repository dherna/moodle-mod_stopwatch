 ...
 * of the new instance.
 *
 * @param stdClass $stopwatch Submitted data from the form in mod_form.php
 * @param mod_stopwatch_mod_form $mform The form instance itself (if needed)
 ...
 *
 * @param stdClass $stopwatch An object from the form in mod_form.php
 * @param mod_stopwatch_mod_form $mform The form instance itself (if needed)
...
function stopwatch_delete_instance($id) {
    ...
    stopwatch_grade_item_delete($stopwatch);
 ...
 * @param stdClass $stopwatch The stopwatch instance record
...
/**
 * Prints single activity item prepared by {@link stopwatch_get_recent_mod_activity()}
 *
...
/**
 * Creates or updates grade item for the given stopwatch instance
 *
 ...
 * @return void
 */
function stopwatch_grade_item_update(stdClass $stopwatch, $reset=false) {
    global $CFG;
    ...
    grade_update('mod/stopwatch', $stopwatch->course, 'mod', 'stopwatch',
            $stopwatch->id, 0, null, $item);
}

/**
 * Delete grade item for given stopwatch instance
 *
 * @param stdClass $stopwatch instance object
 * @return grade_item
 */
function stopwatch_grade_item_delete($stopwatch) {
    global $CFG;
    require_once($CFG->libdir.'/gradelib.php');

    return grade_update('mod/stopwatch', $stopwatch->course, 'mod', 'stopwatch',
            $stopwatch->id, 0, null, array('deleted' => 1));
}
 ...
 * @param stdClass $module current stopwatch instance record
 ...
 * @param navigation_node $stopwatchnode stopwatch administration node
 */
