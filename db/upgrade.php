...
function xmldb_stopwatch_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the stopwatch
     * iself has been upgraded.
     *
     * For each upgrade block, the file stopwatch/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to stopwatch.
        ...
        // Define field intro to be added to stopwatch.
        $table = new xmldb_table('stopwatch');
        ...
        // Define field introformat to be added to stopwatch.
        $table = new xmldb_table('stopwatch');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'stopwatch');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to stopwatch.
        $table = new xmldb_table('stopwatch');
        ...
        // Define field timemodified to be added to stopwatch.
        $table = new xmldb_table('stopwatch');
        ...
        // Define index course (not unique) to be added to stopwatch.
        $table = new xmldb_table('stopwatch');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'stopwatch');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'stopwatch');
    }
